...
class CredentialsProvider
{
    ...
    {
        return function () {
            $accessKeyId     = envNotEmpty('ALIBABA_CLOUD_ACCESS_KEY_ID');
            $accessKeySecret = envNotEmpty('ALIBABA_CLOUD_ACCESS_KEY_SECRET');
    ...
    {
        return function () {
            $ini = envNotEmpty('ALIBABA_CLOUD_CREDENTIALS_FILE');
    ...
    {
        $name = envNotEmpty('ALIBABA_CLOUD_PROFILE');
    ...
    {
        return function () {
            $instance = envNotEmpty('ALIBABA_CLOUD_ECS_METADATA');
            if ($instance) {
