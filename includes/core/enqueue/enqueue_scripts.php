...
function nice_select_scr() {
	wp_enqueue_style( 'nice-select', get_digits_asset_uri( '/assets/css/nice-select.css' ), array(), null, 'all' );
	wp_enqueue_script( 'nice-select', get_digits_asset_uri( '/assets/js/jquery.nice-select.min.js' ), array( 'jquery' ), null );
