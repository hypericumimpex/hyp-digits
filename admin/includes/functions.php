                                ...
                                <div class="dig_preset_item_list">
                                    ...
                                    <div class="dig_preset_img_smp">
                                        ...
                                        <a class="dig_preset_big_img"
                                           big-href="<?php echo get_digits_asset_uri( '/admin/assets/images/preset' . $key . '.jpg' ); ?>">
...
function digits_configure_settings() {
    ...
    <table class="form-table">
        ...
        <tr>
            ...
            <td>
                <select name="dig_wp_login_inte">
                    <option value="1" <?php if ( $wp_login_inte == 1 ) {
						echo 'selected="selected"';
					} ?>><?php _e( 'Yes', 'digits' ); ?></option>
                    <option value="0" <?php if ( $wp_login_inte == 0 ) {
						echo 'selected="selected"';
					} ?>><?php _e( 'No', 'digits' ); ?></option>
                </select>
            </td>
        ...
        <tr id="enabledisableforgotpasswordrow">
            ...
            <td>
                <select name="dig_enable_forgotpass">
                    <option value="1" <?php if ( $digforgotpass == 1 ) {
						echo 'selected="selected"';
					} ?>><?php _e( 'Yes', 'digits' ); ?></option>
                    <option value="0" <?php if ( $digforgotpass == 0 ) {
						echo 'selected="selected"';
					} ?>><?php _e( 'No', 'digits' ); ?></option>
                </select>
        ...
        <tr id="enabledisablestrongpasswordrow">
            ...
            <td>
                <select name="dig_enable_strongpass">
                    <option value="1" <?php if ( $dig_use_strongpass == 1 ) {
						echo 'selected="selected"';
					} ?>><?php _e( 'Yes', 'digits' ); ?></option>
                    <option value="0" <?php if ( $dig_use_strongpass == 0 ) {
						echo 'selected="selected"';
					} ?>><?php _e( 'No', 'digits' ); ?></option>
                </select>
            </td>
        ...
        <tr>
            <th scope="row" style="vertical-align:top;"><label
                        for="login_reg_success_msg"><?php _e( 'Login/Registration Success Message', 'digits' ); ?></label>
            </th>
            <td>
                <select name="login_reg_success_msg">
                    <option value="1" <?php if ( $login_reg_success_msg == 1 ) {
						echo 'selected="selected"';
					} ?>><?php _e( 'Yes', 'digits' ); ?></option>
                    <option value="0" <?php if ( $login_reg_success_msg == 0 ) {
						echo 'selected="selected"';
					} ?>><?php _e( 'No', 'digits' ); ?></option>
            ...
            <tr>
                ...
                <td>
                    <select name="dig_hide_countrycode" id="dig_hide_countrycode">
                        <option value="1" <?php if ( $dig_hide_countrycode == 1 ) {
							echo 'selected="selected"';
						} ?>><?php _e( 'Yes', 'digits' ); ?></option>
                        <option value="0" <?php if ( $dig_hide_countrycode == 0 ) {
							echo 'selected="selected"';
						} ?>><?php _e( 'No', 'digits' ); ?></option>
                    </select>
                </td>
        ...
        <tr>
            ...
            <td>
                <select name="dig_redirect_wc_to_dig">
                    <option value="1" <?php if ( $dig_redirect_wc_to_dig == 1 ) {
						echo 'selected="selected"';
					} ?>><?php _e( 'Yes', 'digits' ); ?></option>
                    <option value="0" <?php if ( $dig_redirect_wc_to_dig == 0 ) {
						echo 'selected="selected"';
					} ?>><?php _e( 'No', 'digits' ); ?></option>
                </select>
            </td>
        ...
        <tr>
            ...
            <td>
                <select name="enable_createcustomeronorder" id="enable_createcustomeronorder">
                    <option value="1" <?php if ( $enable_createcustomeronorder == 1 ) {
						echo 'selected=selected';
					} ?> ><?php _e( 'Yes', 'digits' ); ?>
                    </option>
                    <option value="0" <?php if ( $enable_createcustomeronorder == 0 ) {
						echo 'selected=selected';
					} ?> ><?php _e( 'No', 'digits' ); ?>
                    </option>
                </select>
    ...
    <table class="form-table dig_cs_re">
        <tr>
            <th scope="row"><label
                        for="digits_myaccount_redirect"><?php _e( 'My Account Redirect', 'digits' ); ?></label></th>
            <td>
