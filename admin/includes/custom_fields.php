        ...
        <tr id="enableregistrationrow">
            ...
            <td>
                <select name="dig_enable_registration">
                    <option value="1" <?php if ( $user_can_register == 1 ) {
						echo 'selected="selected"';
					} ?>><?php _e( 'Yes', 'digits' ); ?></option>
                    <option value="0" <?php if ( $user_can_register == 0 ) {
						echo 'selected="selected"';
        ...
        <tr id="showasteriskrow">
            ...
            <td>
                <select name="dig_show_asterisk">
                    <option value="1" <?php if ( $show_asterisk == 1 ) {
						echo 'selected="selected"';
					} ?>><?php _e( 'Yes', 'digits' ); ?></option>
                    <option value="0" <?php if ( $show_asterisk == 0 ) {
						echo 'selected="selected"';
					} ?>><?php _e( 'No', 'digits' ); ?></option>
                </select>
            </td>
            ...
            <tr>
                ...
                <td>
                    <select name="<?php echo $login_field; ?>"
                            class="dig_custom_field_sel dig_custom_field_login_j" <?php if ( isset( $values['ondis_disable'] ) ) {
						echo 'data-disable="' . $values['ondis_disable'] . '"';
					}
					if ( isset( $values['opt'] ) ) {
						echo 'data-opt="' . $values['opt'] . '"';
					} ?> >
    ...
    <table class="form-table dig-reg-fields <?php if ( is_rtl() ) {
		...
		if ( ! empty( $reg_custom_fields ) ) {
			...
			foreach ( $reg_custom_fields as $label => $values ) {
				...
				?>
                <tr id="dig_cs_<?php echo cust_dig_filter_string( $label ); ?>"
                    class="dig_field_type_<?php echo strtolower( $values['type'] ); ?>" dig-lab="<?php echo $label; ?>">
